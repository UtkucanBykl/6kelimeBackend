...
urlpatterns = [
    ...
    # /detail/{slug}/
    re_path(
        r'^post/(?P<slug>[\w-]+)/$', PostDetailApiView.as_view(), name='post-detail'
    ),
    # /login
    re_path(r'^login/', LoginView.as_view(), name='login'),
    # /posts/category/{cat_name}
    re_path(
        r'^post/category/(?P<cat_name>[\w-]+)/$',
    ...
    # /like/post/{slug}
    re_path(
        r'^like/post/(?P<slug>[\w-]+)/$',
        LikeCreateOrDeleteView.as_view(),
        name='like-create',
    ),
    # /most/like/post
    ...
    # /delete/post/{slug}
    re_path(
        r'^delete/post/(?P<slug>[\w-]+)/$',
        PostDeleteApiView.as_view(),
        name='post-delete',
    ),
    # /unpublish/post/
    re_path(
        r'^unpublish/$', PostUnpublishListAPIView.as_view(), name='post-list-unpublish'
    ),
    # /comment/create/{slug}
    re_path(
        r'^create-comment/(?P<slug>[\w-]+)/$',
